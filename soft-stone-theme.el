...
(custom-theme-set-faces
  'soft-stone
	...
	'(org-hide ((t (:foreground "#708090"))))
        ...
        '(org-todo ((t (:bold t :foreground "#5c0020"))))
        '(org-done ((t (:bold t :foreground "#403d37"))))
        '(org-warning ((t (:underline t :foreground "#ff0000"))))
        '(org-agenda-structure ((t (:weight bold :foreground "#e3e3e3" :background "#929292"))))
        '(org-agenda-date ((t (:foreground "#8aa234" :height 1.2))))
        '(org-agenda-date-weekend ((t (:weight normal :foreground "#626262"))))
